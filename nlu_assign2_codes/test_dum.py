...
f=open("/home1/e1-246-19/nlu/gutenberg/cats1.txt","r")
lem = WordNetLemmatizer()
...
for val in range(val,length1,1):
    emma = open("/home1/e1-246-19/nlu/gutenberg/"+main1[val][0]+".txt")
...
p=dataset[1]
# fit network
model.fit(X, y, epochs=1000, verbose=2,batch_size=1000)
print(generate_seq(model, tokenizer, max_length-1, 'sixteen', 10))
